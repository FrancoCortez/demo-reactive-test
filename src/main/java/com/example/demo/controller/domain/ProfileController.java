...
import com.example.demo.handler.domain.ProfileHandler;
...
@Configuration
@Slf4j
public class ProfileController extends BaseController<ProfileModel, UUID> {
...
//    }
    ...
    public ProfileController(ProfileHandler handler) {
        super(handler, "/profile");
        this.handler = handler;
    }

    @Bean(name = "profile-routes")
